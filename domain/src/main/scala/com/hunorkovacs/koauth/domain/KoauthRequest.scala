...
object KoauthRequest {
  ...
  def apply(
    ...
    new KoauthRequest(method, urlWithoutParams, urlParams, bodyParams, oauthParamsList)
  }
  ...
  def apply(
    ...
    new KoauthRequest(method, urlWithoutParams, urlParams, bodyParams, params)
  }
  ...
  /**
    ...
    * @return A built up KoauthRequest object
    */
  def apply(request: KoauthRequest, paramList: List[(String, String)]): KoauthRequest = {
    new KoauthRequest(
      method = request.method,
      urlWithoutParams = request.urlWithoutParams,
      urlParams = request.urlParams,
      bodyParams = request.bodyParams,
      oauthParamsList = paramList
    )
  }
  ...
  /**
    ...
    * @return A built up KoauthRequest object
    */
  def apply(method: String, url: String, body: Option[String]): KoauthRequest =
    apply(method = method, url = url, authorizationHeader = None, body = body)
  ...
  /**
    ...
    * @return A built up KoauthRequest object
    */
  def apply(method: String, url: String, authorizationHeader: Option[String], body: Option[String]): KoauthRequest = {
    val urlNoFragment =
    ...
    new KoauthRequest(method, urlWithoutParams, urlParams, bodyParams, extractOauthParams(authorizationHeader))
  }
  ...
  def extractUrlParams(params: String): List[(String, String)] =
